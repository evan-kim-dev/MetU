  ...
  return (
    <button
      ...
      className={[
        ...
        selected
          ? "border-brand/30 bg-gradient-to-br from-brand/10 to-brand-soft/10 text-brand-strong shadow-soft ring-1 ring-brand/15"
          : "border-line-soft bg-surface-white/90 text-ink-body backdrop-blur-sm hover:border-brand/20 hover:bg-surface-soft",
      ].join(" ")}
    >
